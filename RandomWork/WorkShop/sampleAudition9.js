...
function toFindEvens(startingNumber, endingNumber, stepNumber){
	...
	for(var loopCounterIndex = startingNumber; loopCounterIndex < endingNumber; loopCounterIndex += stepNumber){
		if(loopCounterIndex % 2 === 0){
			evenNumbers.push(loopCounterIndex);
		}
	}
...
function validate(){
	...
	document.getElementById("evenNumbersResult").innerText = toFindEvens(startingNumber, endingNumber, stepNumber);
